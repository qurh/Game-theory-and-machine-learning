# -*- coding: utf-8 -*-
"""
Created on Wed Jun 26 19:54:57 2024
...
def create_er_graph_with_partner_switching(n, m, c_fraction, w, u, alpha, max_iterations):
    ...
    def fermi_function(pi, pj):
       # To avoid overflow in exp, we clip the values of alpha * (pi - pj)
...
def run_simulations(n, m, c_fraction, alpha, variable_param, fixed_param, param_values, num_simulations):
    ...
    for value in tqdm(param_values, desc=f"Running simulations for {variable_param}"):
        ...
        for _ in range(num_simulations):
            final_fraction = create_er_graph_with_partner_switching(n, m, c_fraction, w, u, alpha, 10000)
            cooperator_fractions.append(final_fraction)
...
num_simulations = 10  # Number of simulations per data point
